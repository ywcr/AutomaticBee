  ...
  (p.prototype.config = {
    ...
    (p.prototype.initIE = function () {
      ...
      i("#" + f)[0] || i("body").append(n),
        t.elem.next().hasClass(c) ||
          (e.elemFile.wrap(a),
          t.elem.next("." + c).append(
            (function () {
              var e = [];
              return (
    ...
    (p.prototype.msg = function (e) {
      return t.msg(e, { icon: 2, shift: 6, offset: ["40%", "40%"] });
    }),
