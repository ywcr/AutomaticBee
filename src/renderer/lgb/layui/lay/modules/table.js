  ...
  (F.prototype.config = {
    ...
    (F.prototype.render = function () {
      ...
      var l = a.elem,
        n = l.next("." + p),
        o = (e.elem = t(
          i(z).render({ VIEW_CLASS: p, data: a, index: e.index })
        ));
      if (
        ((a.index = e.index),
        n[0] && n.remove(),
    ...
    (F.prototype.reload = function (e) {
      var i = this;
      i.config.data &&
        i.config.data.constructor === Array &&
            ...
            o = [
              ...
              '<div class="layui-table-cell laytable-cell-' +
                ...
                (function () {
                  ...
                  return t.totalRow
                    ? parseInt(a[n]) == a[n]
                      ? parseFloat(a[n]).toFixed(0)
                      : parseFloat(a[n]).toFixed(4) || e
                    : e;
                })(),
              "</div></td>",
            ].join("");
    ...
    (F.prototype.sort = function (e, i, a, l) {
      ...
      (c.sortKey = { field: n, sort: i }),
        ...
        l && layui.event.call(e, u, "sort(" + y + ")", { field: n, type: i });
    }),
      ...
      a.layTool.on("click", "*[lay-event]", function (e) {
        var i = t(this),
          ...
          s = function (e) {
            ...
            n.html(l),
              o.height &&
                n.css("max-height", o.height - (a.layTool.outerHeight() || 50)),
                  ...
                  layui.each(o.cols, function (e, t) {
                    layui.each(t, function (t, i) {
                      if (e + "-" + t === n) {
                        ...
                        (i.hide = !l),
                          a.elem
                            .find('*[data-key="' + o.index + "-" + n + '"]')
                            [l ? "removeClass" : "addClass"](y),
                ...
                return e
                  ? (function () {
                      return "function" == typeof e
                        ? e(r)
                        : i(t(e).html() || this.value).render(r);
                    })()
                  : a;
              })(this.value)
            ),
    ...
    (d.reload = function (e, i) {
      ...
      if (a)
        return (
          i.data && i.data.constructor === Array && delete a.data,
